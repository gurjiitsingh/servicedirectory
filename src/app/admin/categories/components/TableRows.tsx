...
if(result.errors){
  ...
  return (
    <TableRow key={category.id} className="whitespace-nowrap bg-slate-50 rounded-lg p-1 my-1">
       <TableCell>
      ...
      <TableCell>
        <p className="flex gap-3">
          ...
          <Button onClick={()=>handleDelete(category)} size="sm" className="bg-red-600 px-1 py-0 ">
